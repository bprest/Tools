...
model1 = glm(death ~ cb1.pm + cb1.temp + ns(time, 7*14) + dow, family=quasipoisson(), data=chicagoNMMAPS)
summary(model1)
...
par(mfrow=c(1,2))
plot(pred1.pm, "slices", var=20, col=3, ylab="RR", ci.arg=list(density=15,lwd=2),
     main="Association with a 10-unit increase in PM10")
lines(pred1.pm, "slices", var=10, col=3, ylab="RR", ci.arg=list(density=15,lwd=2),
     main="Association with a 10-unit increase in PM10", lty=2)
plot(pred1.pm, "slices", var=20, col=2, cumul=TRUE, ylab="Cumulative RR",
     main="Cumulative association with a 10-unit increase in PM10")
lines(pred1.pm, "slices", var=10, col=2, cumul=TRUE, ylab="Cumulative RR",
     main="Cumulative association with a 10-unit increase in PM10", lty=2)
...
model1 = glm(death ~ cb1.pm, family=gaussian(), data=chicagoNMMAPS)
summary(model1)
